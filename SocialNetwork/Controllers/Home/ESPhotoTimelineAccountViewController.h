 ...
 */
@interface ESPhotoTimelineAccountViewController : PFQueryTableViewController <ESPhotoHeaderViewDelegate,UITableViewDelegate,ESPhotoFooterViewDelegate, ESFindFriendsCellDelegate>
/**
