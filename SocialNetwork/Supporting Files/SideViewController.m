...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            [avatarImageView setImage:[UIImage imageNamed:@"IconFollowers"]];
            avatarImageView.alpha = 0.5;
            [cell.contentView addSubview:avatarImageView];
        }
            ...
            [avatarImageView setImage:[UIImage imageNamed:@"Logout"]];
            avatarImageView.alpha = 0.5;
            [cell.contentView addSubview:avatarImageView];
            ...
            [avatarImageView setImage:[UIImage imageNamed:@"ButtonImageSettings"]];
            avatarImageView.alpha = 0.5;
            [cell.contentView addSubview:avatarImageView];
        }
